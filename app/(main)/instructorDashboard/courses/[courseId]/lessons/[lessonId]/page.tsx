...
import { Box, Button, Typography, IconButton, List, ListItem, ListItemText, Paper, Divider, CircularProgress } from '@mui/material';
import CloudUploadIcon from '@mui/icons-material/CloudUpload';
import AttachFileIcon from '@mui/icons-material/AttachFile';
import DeleteIcon from '@mui/icons-material/Delete';
import { addFiles, addVideo, getLesson, deleteVideo } from '@/demo/service/CourseServices';
...
const LessonContent = () => {
    ...
    const [videoPreview, setVideoPreview] = useState<string | null>(null); // To store the video URL fetched from the lesson
    ...
    const removeFile = (fileToRemove: File) => {
        setAdditionalFiles(additionalFiles.filter((file) => file !== fileToRemove));
    };
