    ...
    const dataViewHeader = (
        <div className="flex flex-column md:flex-row md:justify-content-between gap-2">
            ...
            <span className="p-input-icon-left">
                ...
                <InputText value={globalFilterValue} onChange={onFilter} placeholder={t('search.placeholder')} />
            </span>
            ...
            <div className="col-12">
                <div className="flex flex-column md:flex-row align-items-center p-3 w-full">
                    ...
                    <div className="flex-1 flex flex-column align-items-center text-center md:text-left">
                        ...
                        <div style={{ wordBreak: 'break-all' }} className="mb-2">{description}</div>
                    ...
                    <div style={{ gap: '10px', flexWrap: 'wrap' }} className="flex flex-row md:flex-column justify-content-between w-full md:w-auto align-items-center md:align-items-end mt-5 md:mt-0">
                        <span className="text-2xl font-semibold mb-2 align-self-center md:align-self-end">{enrolledStudentsNumber.toString()} {t('students')}</span>
            ...
            <div className="col-12 lg:col-6 flex mb-6">
                <div style={{width : '520px'}} className="card m-3 border-1 surface-border flex flex-column ">
                    ...
                    <div className="flex flex-column align-items-center text-center mb-3">
                        ...
                        <div style={{ wordBreak: 'break-all' }} className="">{course.description}</div>
                    </div>
